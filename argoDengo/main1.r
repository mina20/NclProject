...
#### loading data ####
#all_data <- load_data()
data <- read.csv("/home/gadgil/samina/argoDengo/inst/extdata/GT.csv")
data1 <- read.csv("/home/gadgil/samina/argoDengo/inst/extdata/CD.csv")

exogen <- list(data)
yx_merged <- merge(list(data1), exogen, join = "right")
